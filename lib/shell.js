...
var ShellObject = function() {
    ...
    this.allowUnsafeOperator = false;
    ...
    this.validate = function(s) {
        if (!this.allowUnsafeOperator) {
            if (/[><^()]/.test(s)) {
                throw new Error(
                    "Unsafe shell operator is not allowed. " +
                    "Set allowUnsafeOperator to true to allow unsafe operators."
                );
            }
        }
    };
...
exports.VERSIONINFO = "Windows Shell Interface (shell.js) version 0.3.19";
