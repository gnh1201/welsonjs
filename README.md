...
- LLM AI integrations: [ChatGPT](https://openai.com/index/chatgpt/), [Claude](https://claude.ai/), [Grok](https://x.ai/), [LLaMA on Groq](https://groq.com/), [Gemini](https://gemini.google.com/), [Mistral](https://mistral.ai/), [DeepSeek](https://www.deepseek.com/), [Kimi](https://kimi.moonshot.cn/), sLLM ([OpenChat](https://github.com/imoneoi/openchat), [Qwen](https://chat.qwenlm.ai/), [Gamma](https://ai.google.dev/gemma))
