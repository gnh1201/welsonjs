...
- Text generative AI integrations
  ...
  - sLLM: [OpenChat](https://github.com/imoneoi/openchat), [Qwen](https://chat.qwenlm.ai/), [Gemma](https://ai.google.dev/gemma), [Cybertron 7B v2](https://huggingface.co/fblgit/una-cybertron-7b-v2-bf16), [Starling-LM-7B-beta](https://starling.cs.berkeley.edu/), [Hermes 2 Pro](https://huggingface.co/NousResearch/Hermes-2-Pro-Mistral-7B)
