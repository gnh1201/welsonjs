...
* Native modules for Windows environments: Write a Windows Service Application with JavaScript, Control a window handles, Virtual mouse and keyboard events, [Named Shared Memory](https://learn.microsoft.com/en-us/windows/win32/memory/creating-named-shared-memory?utm_source=welsonjs) based [IPC](https://qiita.com/gnh1201/items/4e70dccdb7adacf0ace5?utm_source=welsonjs)
